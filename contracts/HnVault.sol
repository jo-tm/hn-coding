...
@title HnVault
@license GNU GPLv3
@notice A vault to be rebalanced
*/
...
contract HnVault {
  ...
  /* Kovan Addresses */
  address public daiAddress = 0x6B175474E89094C44Da98b954EedeAC495271d0F; //0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa;
  address public wethAddress = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2; //0xd0A1E359811322d97991E03f863a0C30C2cF029C;
  ...
  event HnVaultLog(string msg, uint ref);

  constructor() {
    console.log('Deploying HnVault Version:', version);
  ...
  function buyWeth(uint amountUSD) public {
    ...
    emit HnVaultLog('amountIn', amountIn);
  ...
  function sellWeth(uint amountUSD) public {
    uint256 deadline = block.timestamp + 15;
    uint24 fee = 3000;
    address recipient = address(this);
  ...
  function rebalance() public {
    ...
    if (usdBalancePercentage < usdTargetPercentage) {
      ...
      emit HnVaultLog('amountToBuy', amountToBuy);
  ...
  function wrapETH() public {
    ...
    emit HnVaultLog('wrapETH', ethBalance);
